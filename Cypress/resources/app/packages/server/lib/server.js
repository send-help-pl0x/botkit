(function() {
  var DEFAULT_DOMAIN_NAME, Promise, Request, Server, Socket, _, allowDestroy, appData, blacklist, buffers, check, compression, connect, cookie, cors, cwd, debug, errors, evilDns, exphbs, express, fileServer, fullyQualifiedRe, headersUtil, http, httpProxy, httpsProxy, la, logger, notSSE, origin, setProxiedUrl, statusCode, stream, uri, url;
          ...
          return function(resolve, reject) {
            ...
            handleReqStream = function(str) {
              ...
              return pt = str.on("error", error).on("response", function(incomingRes) {
                var jar;
                debug("got resolve:url response %o", _.pick(incomingRes, "headers", "statusCode"));
