...
function Botkit(configuration) {
    ...
    function Conversation(task, message) {
        ...
        this.handle = function(message) {
            ...
            //The else statement here has taken out because it doesn't do anything according to the comment.
        };
        ...
        //Helper function for the handleAction()'s first case statement
        this.execute_script = function(that,thread,script){
            ...
            switch (condition.action) {
                case 'execute_script':
                    if (condition.execute) {
                        ...
                        that.execute_script(that,thread,script);  
                    }
                    break;
                ...
                case 'stop':
                    ...
                    break;
                case 'wait':
                    //The silentRepeat() function has been removed because all it does is just break out from the main function
                    return;
                case 'complete':
                    that.stop('completed');
                    break;
        ...
        this.repeat = function() {
            ...
            //The Else statement has been removed because it doesn't do anything
        };
        ...
        this.tick = function() {
            ...
            if (this.isActive()) {
                //The this.process if statement has been removed because it doesn't do anything
                if (this.handler) {
                       /*
                        * check timeout!
                    ...
                    if (this.messages.length) {
                        ...
                        //Removed the else statement because it doesn't do anything
